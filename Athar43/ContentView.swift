...
//  Athar43
//
//  Created by Renad Alyousef on 15/06/1446 AH.
//
import SwiftUI
            ...
            VStack {
                ...
                HStack(spacing: 100) { // Increased spacing
                    VStack(spacing: 10) {
                        ...
                        // Text Box for Girl Name
                                              RoundedRectangle(cornerRadius: 15)
                                                  .fill(Color.pink .opacity(0.8)) // Background color with transparency
                    ...
                    VStack(spacing: 10) {
                        ...
                        RoundedRectangle(cornerRadius: 15)
                            .fill(Color.purple
                                .opacity(0.8)) // Background color with transparency
                                                   .frame(width: 150, height: 60) // Set size for the box
                                                   .overlay(
                                                       Text("سعد")
                                                           .font(.title)
